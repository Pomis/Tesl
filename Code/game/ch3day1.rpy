...
label ch3day1:  
    ...
    menu:
    	...
    	"смотреть картинки":
    		...
    		"Занятие напомнило мне школьный урок биологии, там нам показывали картинки животных и рассказывали как они живут и что едят."
    		 "Однако тут было небольшое отличие - про каждое существо нам подробно обьясняли как его убить."
    		 "Арсенал живой силы противника пугал своим разнообразием, нам обьяснили, что это специально созданные животные для уничтожения людей." 
    ...
    "Занятие шло окоро 3 часов и голова уже шла кругом, но наконец пришло время обеда"
    "Нам дали пол часа чтобы поесть, а потом все вместе мы пошли практиковаться в полученных знаниях - мы пошли в ... тир"
    sl "Слава: Тир? Я бы назвал это место полигоном"
    "Людей здесь было много, а оружия - ещё больше, как на чёрном рынке."
    "Кругом ходили крутые мужики из блокбастеров с футуристическими пушками наперевес и картина в целом заставляла поверить меня, что я попал в фильм. {w}Но нас провели мимо стендов с оружием к стойке с креслами."
    ...
    "Восхищаться ощущениями я мог бы долго, но из-за холма вдруг материализовалось некое существо и, подскачив, снесло мне голову." 
    ...
    if killPoints == 1:
    	...
    	"Значит, симулятор коммандный и я могу встретить здесь остальных своих одногруппников."
    ...
    "несколько секунд спустя я опять сидел в кресле симулятора и любвался бетонной стеной."
