        ...
        "Посмотреть налево":
            ...
            if playedChess:
                ...
                if chesspoints == true:
                    ...
                    "Ох, чувствую, что он успеет меня достать."
                    "— Ты слишком скучен. Мне не интересно с тобой общаться. Ну так и быть, меня зовут [playerName]."
                    if strangerPoints>0:
                        stranger "— [playerName] значит. Буду знать."
                        "Тенко загадочно улыбнулся. Какая-то неприятная у него улыбка."
                    else: 
                        ""
                        # bulka: Вот тут пока не проработал.
                ...
                if seenChessGame:
                    ...
                    "Я посмотрел налево и увидел странного парня, вращающего в руках чёрную шахматную фигуру."
                    "Король. Или ферзь. Не знаю."
                "— Привет, что ли. Меня зовут [playerName]."
                stranger "— Тенко. Будем знакомы. Хотя, ты мне не особо интересен."
                "— Это ещё почему?"
                stranger "— А чем ты можешь быть мне полезен?"
