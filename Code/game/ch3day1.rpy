...
label ch3day1:
    ...
    isq0 "— А кто-нибудь вообще встречал этих Инферно? Кроме организаторов."
    ...
    isc "— Искра."
    $ knowIsqraName == True
    # bulka: Ненужная переменная, но раз в скрипт вписали, то и тут добавлю.
    sl "— Буря. Безу..."
    "Лёгкий удар книгой по голове помешал Славе закончить."
