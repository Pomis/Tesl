...
label ch3day1:
    ...
    "Проснулся я от грохота распахнувшейся настеж двери и громогласного «РОТА ПОДЪЁМ!». В дверях стоял крепкий паренёк" # типа булата из акаме, даёшь яой в массы лол
    # bpaw: Нет яою. А Булата убили. ГГ потом его костюм носил
    # bulka: Тут у нас Рома тоже в Джорджа Мартина играл...
    show jorik angry onlayer middle with vpunch
    play music dobrogo
    show jorik kidding onlayer middle with dissolve
    ...
    show jorik laugh onlayer middle with dissolve
    ...
    show jorik usual onlayer middle with dissolve
    ...
    "Всего нас шестеро: четверо парней, две девушки."
    ...
    "— Кажется, ты говорил, что нас должно было быть пятеро?"
    sl "— Может ещё кого-то нашли."
    ...
    show jorik shocking with dissolve
    co "— Чтоб через 10 минут каждый из вас знал всё о каждом из вашей группы!"
    co "— Кто, откуда, какой цвет глаз у его собаки и вообще всё, буду спрашивать устно и сверять с досье, кто расскажет больше всех получит...{w} Ничего! Поехали!"
    "Я напрягся."
    ...
    # bpaw: Необщительный? Да этот псевдо-хикка доводил Юминг до цундеризма
    # bulka: И? Я вот сегодня на паре, когда куча народа была, и слова преподу сказать толком не смог. А потом, когда все разошлись, изи на зачёт развёл. Умение говорить наедине и умение говорить в обществе - совершенно разные навыки коммуникации, которые, зачастую, не связаны с друг другом. 
    ...
    menu:
        "Посмотреть направо":
            ...
            mi "— М-меня зовут Миямото Минори."
            "— Привет...{w} А я [playerFullName]. Приятно познакомиться!"
            ...
            # pomis: обыграл на следующем дне
            # pomis: дно, ха-ха
            # bulka: Сначал подумал, что это о нижнем предложении - сделать ошибку в вопросе о русском языке, и проржался.
            # bpaw: Миямото есть фамилия? Если так, то так, если нет то нет. Они всегда амилию сначала
            ...
            # pomis: надо будет ещё где-нибудь упомянуть австралийские берега.
            mi "— Я боюсь кенгуру."
            mi "— И пингвинов."
            mi "— И... А, неважно..."
            ...
            if inferno:
                "— Я тоже попал сюда пройдя тест.{w} Кстати, а кем ты была в обычной жизни?"
                mi "— В обычной? Так говоришь, будто она закончилась..."
                "— Так ты не понимаешь, что вообще происходит?"
                mi "— Честно говоря... {w}Не особо."
                "Она снова понурила голову."
                mi "— Я обычная японская школьница. Я ничего не понимаю! Хочу домой!"
                "Мда, стандартное сохранение статуса кво. Просто отложить проблемы. Если проблема со временем разрешится сама собой, лучше вообще туда не лезть. Что? Говорите, проблемы могут расти? Постарайся изо всех сил, будущий я."
                "Некоторое время мы провели в молчании, но она всё-таки нарушила тишину."
                mi "— А тебе не страшно?"
                menu:
                    "— Нет, совсем.":
                        $ minoriPoints += 1
                        "— Да и мне терять нечего. Мои родители погибли при кораблекрушении, которое, кстати, было по вине армии."
                    "— Есть немного...":
                        "— Да, страшновато немного... {w}Но, мне и терять нечего. Мои родители погибли при кораблекрушении, которое, кстати, было по вине армии."
                ...
                # bpaw: ООО ачивки. Нужно много ачивок. Как минимум одну сложнополучаемую
                "— А что мне остаётся..."
                mi "— И правда."
                if liePoints==0:
                    $ minoriSuspects = True
                ...
                menu:
                    "Придумать историю.":
                        if liePoints>1:
                            $ liePoints += 1
                            # bpaw: Поменял местами, сам подумой почему
                            "— При кораблекрушении я нашёл осколки странного оборудования. Когда я добрался домой, я стал исследовать эти осколки. Стал спрашивать на форумах. И одним утром мне в дверь постучался огромный мужик в военной форме, которого сопровождали ещё трое военных."
                            mi "— А, это генерал Ганц!"
                        else:
                            "— Я решил найти тех, кто борется с Инферно. Я прошерстил весь Интернет и нашёл упоминания об этой организации. Далее, я вычислил координаты."
                            mi "— Как-то слабо верится, ну ладно."
                    "Рассказать как есть.":
                        "Я пересказал ей всё так, как было. Судя по всему, она любит слушать всякие истории."
                        "Точно, для неё это как будто бы какая-то история. Её же это никак не касается. И почему я рассчитывал на сочувствие?"
            co "— Осталось пять минут!"
        ...
        "Посмотреть налево":
            ...
            show tenko surpriced onlayer master:
                xpos 0.07 ypos 1.16 yanchor 1.0 zoom 1.17 
            play music gagarin
            if playedChess:
                ...
                # TODO: нарисовать в один спрайт чёрного короля
                "Неужели он так помешан на шахматах?"
                if chesspoints:
                    ...
                    if wonchess:
                        ...
                        "— Ну, так уж и быть, меня зовут [playerName]."
                    else:
                        $ useless = True
                    ...
                    if tenkoPoints>0:
                        ...
                        if antiTenkoPoints == 0:
                            ...
                            # bpaw: Я походу понял, зачем антитенкопоинты
                ...
                "— Привет, что ли. Меня зовут [playerName]."
                ten "— Тенко. Будем знакомы. Хотя, {w}ты мне не особо интересен."
                "— Это ещё почему?"
                ten "— А чем ты можешь быть мне полезен?"
                "Я даже не знаю, что и ответить на такое."
                ten "— Ладно, не парься, просто было интересно, как ты отреагируешь."
                "Тенко слегка усмехнулся."
            ten "— Этот координатор... {w}Готов поспорить, он уже забыл, что хотел от нас."
            if useless:
            ...
            if inferno:
                if playedChess:
                    if tenkoPoints>0:
                        # bpaw: Дикая ифка. В ренпи можно делать что-то типа if a>b and b>c как в руби?
                        ...
                        if antiTenkoPoints>0:
                            ...
                            if antiTenkoPoints>1 or liePoints>0:
                                ...
                                "Хех. Не на того напал. Меня так легко не раскусишь."
                            else:
                    ...
                    ten "— Так. А ты не так прост, как кажешься на первый взгляд. Уже убивал?"
                    "Меня бросило в холодную дрожь от такого вопроса."
                    # bpaw: Булка прошёл мимо повторения?
                    # bulka: А я не выискиваю подобные косяки. Только когда бросаются в глаза сами, исправляю. Ибо на этой стадии от этого проку мало. Скорее всего, это повторение как раз я и сделал спросонья.
                    menu:
                        # bulka: А вот давать ли tenkoPoints тут? Сейчас их суть в том, что если их больше одного Тенко подстережёт у вентеляции.
                        "Отрицать.":
                                $ liePoints += 1
                                $ tenkoAttention += 2
                                "— Нет, с чего бы?"
    ...
    menu:
        ...
        "— Какую роль?":
            ...
            # bpaw: Я считаю нужным фигачить даблъю после каждого ...
            # bulka: Мои тебе поздравления. Спасибо, оставайтесь на связи - ваше мнение очень важное для нас...
    ...
    menu:
        "— А вдруг, это Инферно нуждаются в защите от нас?" if inferno:
            ...
            sl "— Совсем дурак?"
            isc0 "— Всё возможно..."
            "Это она о моих словах или о том, что я дурак?"
        "— Однако, слепо убивать тоже не круто." if inferno==False:
            $ iscraPoints += 1
            isc0 "— Хоть кто-то здравомыслящий тут!"
            sl "— Они враги всего человечества. Какая разница, слепо, не слепо..."
            isc0 "— Ты же ничего о них не знаешь."
            sl "— По крайней мере, я знаю, как их уничтожать."
            isc0 "— Что ещё ожидать от солдафона..."
            # bulka: Не уверен, что цивилизация - подходящее слово для реплики такого индивида, как Слава.
            # bpaw: Уж это слово он знает
            # bulka: Только вот враги планеты - это люди, а не инферно...
    ...
    co "— В следующие 6 дней я буду рассказывать вам о нашем противнике и оружии, а также о вашей роли в боевых действиях."
    ...
    co "— В конце курса — на седьмой день — будет нечто вроде экзамена, вас распределят в определённые отряды, где вы будете служить и продолжать свои тренировки уже на конкретном типе вооружений."
    co "— Есть вопросы?"
        ...
        "Почитать листовку":
            ...
            menu:
                "Читать до конца":
                    ...
                    nvl clear
                    nvlc "Это увеличивало скорость реакции на несколько порядков. Однако далеко не каждый человек мог стать таким пилотом: у обычного человека нервная система не способна развиваться после того, как она полностью сформируется. И лишь в одном из миллионов случаев человек был открыт к таким модификациям нервной системы. И чем человек старше, тем больше шанс, что его нервная система уже закрыта. Поэтому среди людей возраста до 25 лет было проведено массовое исследование, с целью якобы всеобщей проверки на новый вид вируса приобретённого иммунодефицита, который распространился примерно 20 лет назад, и находится в спящей форме.  С теми людьми, которые подходили на роль пилотов, связывались военные и вербовали на службу. "
            ...
            # bpaw: На вики есть статья Инферно, которая круче файла.
        "Смотреть презентацию":
            $ gunPoints += 2
            scene bg educlass titan
            ...
            # bpaw: Что будет если ты умрёшь? Загрузка с чекпоинта?
            "Занятие напомнило мне школьный урок биологии, там нам показывали картинки животных и рассказывали как они живут и что едят."
            "Однако тут было небольшое отличие — про каждое существо нам подробно объясняли как его убить."
            "Арсенал живой силы противника пугал своим разнообразием, нам объяснили, что это специально созданные животные для уничтожения людей." 
    scene bg educlass titan
    ...
    scene bg diner with dissolve
    co "— У вас полчаса на обед."
    "Мы сели со Славой за столик и обсуждали услышанное."
    isc "— Как ты там сказал? Молчи женщина?"
    "От агрессивного тона этой девушки даже мне стало не по себе. А нам ещё с монстрами сражаться..."
    "Искра одарила нас презрительным взглядом и села за самый отдалённый столик, а Слава не смог сообразить, что ответить вслед."
    sl "— Да уж..."
    # "Нам дали полчаса, чтобы поесть, после чего нас собрали у лифта."
    "— Что сейчас?"
    co "— Как я уже говорил, практика! Идём в тир!"
    sl "— Круто, круто! Какие там пушки есть?"
    co "— На любой вкус и цвет."
    ...
    "— Как будто я так часто им пользуюсь, чтобы предпочитать что-то."
    "Но если подумать..."
    menu:
        "— Автоматы":
            $ slavaPoints += 1
            sl "— О, я тоже! Правда, довелось только из калаша пострелять..."
        ...
        "— Мечи":
            ...
            "— Ого, настоящая самурайская катана?"
            mi "— Ну, не совсем самурайская..."
        # bulka: Нет добра. Без петли и топора!"
        "— Не любитель оружия":
            if inferno:
                "Если, конечно, рацию нельзя назвать оружием."
            sl "— Да ладно? А придётся полюбить."
            isc "— Да, здесь из тебя воспитают настоящего {i}убийцу{/i}."
            # bulka: Врубаем аудиозапись "м/ф "Мулан" – Ты боец".
            # bpaw: авторские права низзя
            # bulka: Да ты что? Не может быть...
    nvl clear
    nvlc "Людей здесь было много, а оружия — ещё больше, как на чёрном рынке."
    nvlc "Кругом ходили крутые мужики из блокбастеров с футуристическими пушками наперевес, и картина в целом заставляла поверить меня, что я попал в фильм."
    scene bg poligon door
    nvlc "Но нас провели мимо этого тира к двери с загадочной надписью Neuro VR. Внутри нас ждали какие-то необычные кресла."
    ...
    nvl clear
    nvlc "Экранов у этих симуляторов не было, но как только я сел, то понял, что экраны и не нужны.{w} Нейроинтерфейс.{w} Настоящая виртуальная реальность. Чувства были необычными — я всё ещё видел, что происходило вокруг, но понемногу поверх этого начала прорисовываться другая картинка, а моё тело будто проваливалось во что-то вязкое, в какой-то кисель. Я попробовал пошевелить рукой и увидел, как из неё появилась виртуальная рука и выполнила все мои движения, в то время как моя настоящая конечность лишь слабо дёрнулась, всё ещё пытаясь сохранить связь с мозгом. И после этого симуляция окончательно заменила реальный мир."
        ...
        # bpaw: шотлинк сделать не судьба
        # bpaw: Кстати, в Гиперионе Симмонса такая же фигня вроде была.
    nvlc "Я сидел в таком же кресле посреди парковки. Первое, что бросилось мне в глаза был вулкан.{w} И он извергался. Парковка была посреди его склона и лава уже достигала её, справа виднелся горящий дом. Для меня всё это оставалось лишь симуляцией, и я решил поглазеть по сторонам, наслаждаясь видом. Восхищаться ощущениями я мог бы долго, но из-за холма вдруг материализовалось некое существо и, подскочив, снесло мне голову. Я вздрогнул и обнаружил себя сидящим в кресле и пялящимся в стену."
    nvl clear
    co "— Что, уже всё? Меньше 30 секунд! Ты мужик, или кто? Давай, мочи эту тварь! Пошёл!"
    nvlc "И я снова нырнул в виртуальный мир."
    if gunPoints >= 1:
        nvlc "В этот раз я уже знал, чего ожидать. Тварь была мне знакома из первого урока, и я знал, как её убить."
        nvlc "На поясе у меня было обычное оружие — пистолет, но этого было достаточно, и я быстро справился со своим первым врагом. В лучших традициях шутеров тело поверженного монстра исчезло, оставив после себя какой-то предмет.{w} Им оказался навигатор с отмеченной точкой «пункт сбора команды». Значит, симулятор командный, и я могу встретить здесь остальных своих одногруппников."
        "Ну, выбора нет, нужно идти к ним. По пути я уничтожил ещё пару противников, подобрав с них несколько гранат. Точка сбора уже близко. *треск*"


    if gunPoints == 0:
        nvlc "Встречаться с этой тварью ещё раз желания у меня не было, да и из оружия у меня был всего лишь пистолет, что казалось мне просто издевательством. Хотя, возможно нас испытывают. Но гнаться за результатами я не стал и решил просто сбежать." 
        nvlc "Убежав вниз по дороге, я увидел море. Значит, карта ограничена водой и далеко уйти не получится. Этот симулятор вроде основан на реальных событиях, значит это всё где-то произошло. Вулкан.{w} Море.{w} Точно!"
        nvlc "Я читал об этом сегодня, кажется, это было нападение на Канарские острова. Там было что-то про лавовых монстров *треск*"

    nvlc "Я повернулся на шум и увидел его. Огромный горящий монстр."
    nvlc "Он окинул меня взглядом."
    nvlc "Ну и громадина!"
    nvl clear
    if gunPoints>=2:
        nvlc "Надо что-то предпринять, срочно. Спрячусь под машину — умру. Побегу по прямой — умру."
        nvlc "Уйти из угла обзора! Я резко прыгнул влево, побежал между машинами, пригнув голову."
        nvlc "Монстр принялся крушить всё на своём пути, к счастью, его путь не пересекался с моим."
        "— Есть кто на связи?"
        sl "— Я тут!"
        "— Нужна нормальная пушка!"
    "Несколько секунд спустя я опять сидел в кресле симулятора и любовался бетонной стеной."
    if gunPoints>=2:
        "— Что произошло?"
        co "— Никогда не упускай врага из поля зрения!"
    ...
    menu:
        ...
        "— Это было нечестно":    
             $ spyPoints += 1
             "— У нас не было такого оружия во время симуляции, это нечестно. Да и стрелять из такой штуки без подготовки... Можешь и сам не выжить"
             co "— Ладно, фиг с вами. Зато теперь будете знать, что такое цезиевый патрон."
             "Он хохотнул и отпустил команду отдыхать."
             co "— Через час тут же!"

    "— Отдыхать? Как?"
    sl "— Давай изучим пушки!"
    pav0 "— Что их изучать? Калаш в руках не держал? Но, в целом, я за."
    co "— Мне нравится ваше рвение!"
    mi "— Здесь есть туалет?"
    "Координатор указал в сторону."
    isc "— А я бы прошлась до столовой и урвала чего-нибудь {i}вкусненького.{/i}"
    menu:
        # "Тоже пойти в туалет":
        #     sl "— Не лучший способ сближаться с девушкой"
        #     "Но мне правда хотелось... "
        # pomis: лень продумыватб, да и тупо
        "Изучить пушки.":
            $ gunPoints += 1
            $ shotFromKalash = True
            ...
            "Слава вертел в руках калаш и по-детски радовался."
            "Павел слегка улыбнулся." #TODO: убрать, сделать на спрайтах
            "Мы попрактиковались в стрельбе из разного оружия, но я так и не узнал имени пухлого парниши. Не особо общительный он. Да и я тоже. А вот Слава комментировал чуть ли не каждый наш выстрел."
        "Пройтись до столовой.":
            if iscraPoints>0:
                $ spyPoints += 1
                isc "— Ладно, пошли."
                scene bg lift with dissolve
                show iscra sad  onlayer master with dissolve:
                    xpos 0.82 ypos 1.0 xanchor 0.5 yanchor 1.0 
                isc "— Вообще, я хотела одна пойти. Но ты, вроде бы, не самый зануда тут."
                "— Ну спасибо."
                scene bg diner with dissolve
                show iscra smiling  onlayer master with dissolve:
                    xpos 0.13 ypos 1.0 xanchor 0.5 yanchor 1.0 
                isc "— Проявляем наглость и берём из холодильника всё, что нравится с невозмутимым видом, понял?"
                "— Это вообще законно?"
                isc "— Чувак, у нас уровень доступа «А». Думаешь, он не распространяется на {i}холодильник?{/i}"
                # bpaw: Искра топ тян
                # bulka: Шутка рли годная. Нужно их побольше. Только вот выделение холодильника шутку портит имхо. Ну или её восприятие.
                "Мы подошли к кухне, выждали момент, когда в ней никого не будет, и стырили несколько яблок."
                show iscra sad onlayer master with dissolve:
                    xpos 0.13 ypos 1.0 xanchor 0.5 yanchor 1.0 
                isc "— Не совсем то, что я хотела, но сойдёт."
                "— В секретной столовой побольше продуктов."
                isc "— Думаешь, она существует?"
                "— Я не могу тебе об этом рассказать."
                isc "— Ну и ладно. Мне без разницы."
                "Однако её вид говорил об обратном."
                "— Что же ты хотела найти?"
                isc "— Тебе-то что? Угадаешь с одной попытки, отдам одно яблоко."
                # pomis: адовая лоторея 1/6 
                menu:
                    "— Конфеты?":
                        isc "— Тоже неплохо, но нет."
                    "— Котлету?":
                        isc "— Я сказала, чего-нибудь {i}вкусненького.{/i}"
                        # bpaw: Искра не любит котлеты. У неё просто котлеты нормальной не было
                    "— Апельсин?":
                        isc "— Тоже неплохо, но нет."
                    "— Шоколад?":
                        isc "— Тоже неплохо, но нет."
                    "— Виноград?":
                        show iscra smiling  onlayer master with dissolve:
                            xpos 0.13 ypos 1.0 xanchor 0.5 yanchor 1.0 
                        $ iscraPoints += 1
                        isc "— В точку. Держи яблоко."
                    "— Пирожок?":
                        isc "— Я сказала, чего-нибудь {i}вкусненького.{/i}"
                        # bulka: Здравстуйвсте, дети.
                        # Здравствуй, человек, портящий весь кайф.
                            # bpaw: +1
                        # bulka: Я пришёл, чтобы сообщить вам, что от выбора должно что-то меняться, когда тут в 5 из 6 случаях от выбора никуя не зависит.
                scene bg lift with dissolve
                scene bg poligon guns with dissolve
                "Перекусив, мы вернулись в тир."
            else:
                isc "— Нет, я одна."
                "Кажется, я ей уже не нравлюсь."
                $ gunPoints += 1
                $ shotFromKalash = True
                # bulka: Вот и выходит, что кто-то клепётся с калашом, ну а кто-то с бабой.
                scene bg poligon tir with dissolve
                pav0 "— Всё это оружие работает на нейроинтерфейсе. Будет проще целиться, всё такое."
                sl "— Не терпится применить на практике!"
                "Слава вертел в руках калаш и по-детски радовался."
    ...
    "После отдыха мы сделали ещё несколько заходов, а ближе к вечеру пошли на курсы выживания."
    "Сами курсы были ни чем иным, как смесь общей физподготовки и основ самообороны без оружия."
    scene bg coridor newbies with dissolve
    ...
    scene bg room mine
    "Ещё целых 6 дней...{w} И зачем мне это всё?"
    "Будто бы есть выбор..."
