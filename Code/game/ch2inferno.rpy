...
label ihateu:
    ...
    "В первую очередь нужно добыть самое сложное - средство убийства. Без него весь план полетит к чёрту."
    ...
    scene bg hospital room sunset onlayer background
    "Мой сосед, как и подобает такому быдлу, очень любит водку. Это можно использовать."
    if $ killN == True:
    ...
    if $ killN == True:
        ...
        "Положив всё в пакетик, который нашёл в первом отделении, я запер тележку и посмотрёл на неё."
        ...
        ""
    nvlc "А теперь пора убить соседа."
