...
#    "— Посмотри в том кей..."
    ...
    "Пытаясь убедить себя, что у предметов нет памяти, если только это незапоминающее устройство, я заставил себя съесть этот сырок. "
    "На обёртке было что-то написано на китайском."
    ...
    "И даже аргумент, что из-за Юминг погибли люди был уже для меня не убедителен."
