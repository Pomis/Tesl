...
label ihateu:
    ...
    "Хотя, вот эти, похоже, действуют. И, кажется, именно так, как мне нужно. Надпись жирным шрифтом «DO NOT USE ORALLY» как бы намекает."
    ...
    "Теперь нужно то, куда это можно добавить. {w}Водка бы была идеальным вариантом, ну или местный аналог самого русского напитка."# pomis: после второй мировой войны водку стали пить по всему миру в знак солидарности русскому народу, так что, в Испании уж водка найдётся.
