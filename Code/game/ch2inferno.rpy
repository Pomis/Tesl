...
label killing:
    "Верно! Чего этот сосед возомнил о себе! Биомусор. Я должен убить его. Земле-матушке и без них тяжело... А с ними ещё тяжелее."
    "Наверное, тяжелее. Кто эту Землю знает?"
    "Как я уже говорил, помнится, тут была тележка с лекарствами..."
    "Почти весь остаток дня я провёл в палате, старательно делая вид, что не обращаю внимание на моего соседа."
    "Однако, я всё-же наблюдал за ним."
    ...
    "Мой сосед, как и подобает русскому человеку, очень любит [drink]. Это можно использовать."
    "Когда я ходил в туалет (поиск — целая эпопея), я узнал точно, где можно найти лекарства."
    # bpaw: Это можно описать
    "Они были около туалета."
    "Внимательно изучив содержимое тележки, я узнал, что там есть медицинский спирт, уксус, местные аналоги парацетамола и прочих смект, много разных верёвок и бинтов."
    # bpaw: Нафига уксус? Илья им убивает. Нужно оправдать наличие уксуса среди лекарств.
    "Как мне это может пригодиться?"
    "Когда я пришёл в палату, этот гад улёгся спать."
    "Убить соседа."
    ...
    # - ГГ имеет много очков агрессии?
    #     - Да; перейти к убийству ножом
    #     - Нет
    #         - ГГ — Илья?
    #             - Да; перейти к убийству водкой
    #             - Нет; перейти к убийству чаем
    # bpaw: О, сцена убийства. Только её тут нет. Сценарист!
