...
label ihateu:
    ...
    if $ killN == True:
        ...
        "Так, а это что?"
        "Маленькие баночки с аллюминивыеми крышками. Явно для внутривенного применения."
        ...
        "Теперь нужно то, куда это можно добавить.{w} Водка бы была идеальным вариантом, но вряд ли в Испании найдётся самый русский напиток."
        "Значит надо поискать местные аналоги."
        ""
    else:
