label ocean:
    ...
    "Но в голове всё мелькали мысли. Взрыв почти расколол корабль надвое, он затанул очень быстро."
    ...
    if agressionPoints>1:
        ...
        $ camera_moves( ( (660, -4100, 430, 0, 2, 'ease') ,(500, -4000, 400, 0, 4, 'ease')  ), loop=True)
