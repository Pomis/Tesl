label ocean:
    ...
    " - Что произошло с кораблём?"
    yu "Он был уничтожен."
    "Она говорит это так спокойно, как будто ничего не произошло. Ещё бы улыбнулась как Путин..."
	# Отсылочка к Курску 
    ...
    " - Да"
    yu "Значит ты у нас способный... Тогда ты имеешь право знать побольше информации."
    " - Какой информации?"
