...
label meetNewCrew:
    ...
    if agreedToPretendHusband:
        ...
        "— Угу."
    "Саргон пропустил мой ответ мимо ушей и внимательно меня рассматривал. Как будто нашёл какую-то любопытную деталь."
    ...
    menu:
        ...
        "Даже не знаю. Может быть.":
            ...
            $ antiSargonPoints += 1
    ma "— Ох, надо бы сообщить Юминг, что я в порядке!"
