...
init:
    ...
    $ antistrangerPoints = 0 # Не самое удачное название для переменной
    ...
    $ useless = False # Очередная переменная для избежания сотни условий (pomis: опять же, странное название)
