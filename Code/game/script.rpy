...
label start:
    ...
    scene bg ocean 
    with dissolve
    "Удержав равновесие, я поднял глаза и увидел океан. Впереди, слева, сзади -- кругом вода. Всё ещё не до конца соображая, я оглядел поверхность на которой стою. "
    ...
    "<...> говноблок"
    show yuming stupid with vpunch
    g "-Как ты меня назвал, придурок?"
