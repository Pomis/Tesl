...
init:
    ...
    $ slavaPoints = 0
    $ gantzPoints = 0
    $ strangerPoints = 0 # bulka: Это вовсе не означает положительное/отрицательные отношения с Тенко. Это лишь степень внимания Тенко к гг. 0 - гг безыинтересен для Тенко. 3 и больше - Тенко просто в каждого дело гг нос сунет, если будет жив.
