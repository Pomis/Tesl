...
init:
    ...
    $ killN = False # Убийство соседа. Возможно, использую с Тенко.
    $ kidN = False  # Подстава соседа. Вначале думал, что только переменной убийства хватит, однако, если всё же с Тенко использую убийство, то это пригодится. Взаимосвязь действий, даттебайо.
