...
init:
    ...
    $ selectedIscraDinner = False # Предпочёл поесть у Искры после того как пообещал Славе поесть с ним
    ...
    $ thoughtAboutSuicide = False # Задумывался о суициде
    ...
    $ allHeilRandom = 1 # мальчишки и девчонки, а также их родители, немножечко рандома, увидеть не хотите ли?
    $ vpunch = False # почему впунч? Потому, что это первое слово, что я увидел, когда думал о переменной.
    ...
    $ slavaPoints = 0
    $ gantzPoints = 0
    $ tenkoPoints = 0 # bulka: Это вовсе не означает положительное/отрицательные отношения с Тенко. Это лишь степень внимания Тенко к гг. 0 - гг безыинтересен для Тенко. 3 и больше - Тенко просто в каждого дело гг нос сунет, если будет жив.
    # bulka: Плевать звучит или нет - реально неудобно искать связанные с Тенко переменные, когда они совершенно по-другому называются.
