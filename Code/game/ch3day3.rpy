label ch3day3:
    ...
    "— Итак, где мы?"
    pav "— Это остров, где находится портал под землю. Фактически, он находится над одним из их городов — над Ниппуром. Там мы сделаем пересадку и перенесёмся в столицу."
