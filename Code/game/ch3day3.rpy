label ch3day3:
    ...
    "До конца поездки (поплывки?) мы не разговаривали."
    ...
    call flashback6
    "Мда. Как говорится: пятёрка в школе - двойка в жизни.(оценки в жизни не помогут) Вот мне это и аукнулось."
