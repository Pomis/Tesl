...
label lab:
    ...
    if visitedLab == True: # Если уже был в лабе 
        $ mariePoints += 1
    ...
    if inferno == True: # bpaw: Нафига я эти пробелы убираю?
        ...
        menu:
            "— Ха-ха. А ты милая":
                ...
                if inferno == True: # bpaw: А пробелы вообще можно убирать?
...
label hangardefault:
    ...
    # bulka: Советую определиться hangar или hungar, ибо потом это аукнется.
    # bulka: Поднимаю этот вопрос ещё раз, ибо до сих пор актуален.
    # pomis: hangar
