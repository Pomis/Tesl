        ...
        if inferno:
            ...
            if stangerPoint>0:
                ...
                if antiTenkoPoints>0:
                    ...
                    ten "— Я давно подозревал, что Павел собирается предать нас."
                    ten "— Когда же к нему присоединился ты, то всё стало очевидно."
                            ...
                            if tenkoAttention>1:
                                ...
                                menu:
                                    "Признаться":
                                        ...
                                        # bulka: Решил поставить менюшек вместо условий. Надо всё-таки выбора же побольше. Тут может появиться Павел, если мы с ним негрубым вариантом сошлись.
                                    ...
                                    "Отрицать":
                                        ...
                                        "Я двинул дулом пистолета в сторону, намекая освободить проход."
                                        "Тенко отошёл в сторону, позволив мне обратно залезть в вентиляцию."
                                        ...
                                        if PavelHelp:
                                            ...
                                            # bulka: Хотя по идее он посмотреть так не мог, ибо в вентеляции. Надо было переделать. Дальше пока не могу.
                            else:
                                ""
                ...
                # bulka: Мб тут что-то случится, что потом использовать в флешбеке?  
