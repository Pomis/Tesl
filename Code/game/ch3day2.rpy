        ...
        if inferno:
            ...
            if stangerPoint>0:
                ...
                if antiTenkoPoints>0:
                    ...
                    tenko "— Когда встречаются две подозрительные личности ничего хорошего произойти не может."
                    tenko "— Я давно подозревал, что Павел собирается предать нас."
                    tenko "— Когда же к нему присоединился ты, то всё стало очевидно."
                    ...
                    menu:
                        "Прогнать его от вентиляции":
                            ...
                            if tenkoAttention>1:
                                tenko "— Брать грех? Какие громкие слова для убийцы. Юминг ты говорил то же самое?"
                                "Юминг? Откуда он знает? Чёрт!"
                                "— Т-ты о чём? Какая ещё Юминг?"
                                tenko "— Не придуривайся. Я изучил последние данные о местонахождении Юминг. Она врезалась в твой корабль и пропала. Ты же по прибытии просишь провести анализ, данные о котором засекречены и, кто бы мог подумать, ты оказываешься способным."
                                "— И что? Это простое совпадение!"
                                "Да кто же ты такой, чёрт тебя побери!"
                                tenko "— Я не верю в совпадения. Особенно когда меня держит на мушке тот, кто должен прикрывать мою спину."
                                tenko "— Та кровь, что я почувствовал. Она же принадлежит Юминг, я прав?"
                                menu:
                                    "Признаться":
                                        $ tenkoAttention += 1
                                        ...
                                        tenko "— Ты же не думал, что я позволю тебе так просто уйти?"
