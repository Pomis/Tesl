        ...
        if inferno:
            ...
            menu:
                ...
                "Попробовать его разговорить":
                    ...
                    "— Только вот корабль, на котором я был вместе семьёй, оказался приманкой для инферно. Там были странные кейсы, которые служили передатчиками."
                    menu:
                        "Я хочу отомстить за это!":
                            ""
                        "Я хочу призвать виновного к ответу!":
                            ""
                    pav "— Нашу деревню тоже сожгли по вине людей!"
                    # bulka: Мысли путаются. Тут один вариант съёба с павлом как и должно быть, а другой переход в рут солдата.
...
label lab:
    ...
    if inferno==True:
        ...
        "— С чего это?"
        ma "— Какой-то ты отличающийся от других новичков. Обычно, новобранца либо охватывает желание поскорее побывать в бою, либо на него всё давит и ему страшно. А ты пофигист какой-то."
