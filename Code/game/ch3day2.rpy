...
label ch3day2:
    ...
    if result == "tir":
        ...
        "— Тот же вопрос хотел бы задать тебе. Да не захотелось идти что-то."
        pav0 "— И это причина не идти? Просто не захотелось?"
        "— А у тебя какая причина? Спасение мира?"
        pav0 "— Что-то в этом роде... Да, честно говоря, тоже не захотелось идти. Просто так."
        "— Избегаешь компаний?"
        ...
        if inferno:
            ...
            # Будет менее агрессивный вариант узнать инфу, но пока хз как
            ...
            # Ну и дальше в том же духе, бла бла бла, я спать
        else:
