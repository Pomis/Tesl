...
label ch3day2:
    ...
    if result == "tir":
        ...
        if inferno:
            ...
            "— Что беремен!"
            if humorousPoints>0:
                noname "— А не теряется. Не слишком ли наглый? Может сразу избавиться от него?"
            else:
            ...
            menu:
                "— Слышь, ты там. Не наглей. Я тебе избавлюсь!":
                    ...
                    # pomis: развил идею
                    noname "— Как вы там говорите, наглость - второе счастье?"
                ...
                "— От полезных ресурсов вредно избавляться.":
                    noname "— Мне импонирует идея, что ты преподносишь себя как ресурс, но я не уверен насчёт твоей полезности."
                    "— У тебя с уверенностью по жизни туго или тебе именно до меня приспичило докопаться?"
                    noname "— Ну ладно. Как вы там говорите, наглость - второе счастье? Смотри только не перебарщивай."
            ...
            noname "— В течение пяти минут к берегу подплывёт ваше плавсредство. Поспешите."
