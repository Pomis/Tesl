...
label lab:
    ...
    # bulka: трахаханьки да трехеханьки
    ...
    if inferno: # bpaw: Нафига я эти пробелы убираю? #pomis: я думал, хотя бы ты знаешь
        ...
        menu:
            "— А мне кажется, это люди во всём виноваты!":
                ...
                # bulka: https://pp.vk.me/c407830/v407830550/8468/HlEUWBeSX-U.jpg
            ...
            "— Спорим, я смогу найти в ней уязвимости?":
                ...
                if inferno:
                    ...
                    if liePoints>2:
                        ...
                        "— Скрою сначала свой айпи казёный, а потом подберу к серверу пароль мудрёный."
