...
label ch3day2:
    ...
    if result == "tir":
        ...
        if inferno:
            ...
            # Тут можно будет ввести сцену, где их кто-то замечает, и выбор, убивать или нет. Но сейчас нет ничем не занятых персонажей, и нет нужды вводить кого-то нового. Если только соседку Юминг, она может ещё где-то пригодится.
