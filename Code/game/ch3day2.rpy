        ...
        if inferno:
            ...
            if stangerPoint>0:
                ...
                # Если не накоплено ни одного antiTenkoPoints
                    ...
                    "— Как же ты достал..."
                    # bulka: Так. Тут сделать разветки с помощью павла надо и дракой и тд. И чтобы слова чуть ниже сочетались со всем развилками. Под градусом короч пробовать это буду. Как говорится - без поллитра не разобраться.
