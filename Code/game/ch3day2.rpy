...
label lab:
    ...
    if inferno==True:
        ...
        "— С чего это?"
        ma "— Какой-то ты отличаешься от других новичков. Обычно, новобранца либо охватывает желание поскорее побывать в бою, либо на него всё давит и ему страшно. А ты пофигист какой-то."
