init:
    ...
    define str = Character('Странный', color="#e1e4e1")
...
label goHome:
    ...
    menu:
        ...
        "Прогуляться по жилому комплексу":
            ...
            "На диванчике расположился странный с забавной причёской. Он разложил на шахматной доске фигуры в случайном порядке и перемещал их."
...
label grossmeister:
    ...
    "— В чём смысл?"
    str "— Смысл? В хаосе. А я тебя никогда не видел. Хм. Новичок? Нет. Тогда бы ты был в корпусе новобранцев..."
    ...
    str "— Ладно, не важно. Не хочешь сыграть партию?"
    ...
    menu:
        "Первый - срубить слоном коня, чтобы разрубить к чертям этот гордиев узел:"
            ...
            str "— Ну что тут скажешь? Неплохо сыграно."
            if inferno == false:
        ...
        "Второй - напасть конём, чтобы сделать то же самое через ход, только с выгодным разменом:"
            str "— Хахаха. Когда заглядываешься вдаль, ты упускаешь то, что вблизи."
            # Или "Когда засматриваешься вглубь, упускаешь то, что на поверхности." Хз какой вариант выбрать.
            if inferno == True:
        ...
        "Третий - пойти вперёд королём, чтобы забрать беззащитного слона следующим ходом:"
            str "— Мдаааааа. Вот тут я немножко ошибся..."
            if inferno == True:
            ...
            "Моя дальнейшая победа была очевидна. Я с лёгкостью расравился с остатками его фигур."
            str "— Ну что тут скажешь? Неплохо сыграно."
            "— Спасибо за игру."
