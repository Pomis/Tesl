    ...
    menu:
        "Да, конечно!":
            ...
            if result == "first":
                ...
                "— Спасибо за игру."
        "Примерно знаю правила.":
            "Я смог правильно расставить фигуры только с его помощью."
            stranger "— Ну что ж, думаю, победитель уже очевиден?"
            "— Посмотрим..."
            "Мне выпала возможность ходить первым. Много пользы из этого я не извлеку, может, хотя бы смогу удивить его безрассудными действиями."
            "— Скачи, мой верный конь!"
            "Я всю игру ходил только конями, пока не потерял их. Теперь пора ходить его фигурами!"
            stranger "— Боже! Ты невыносим! Не буду с тобой больше никогда играть!"
            "— Сдаёшься? Ты казался хладнокровнее."
            stranger "— Всё в порядке. Ладно, [playerName], я уже спать хочу..."
