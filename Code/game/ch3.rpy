...
label goHome:
    ...
    if yumingAlive:
        ...
        if yumingPoints>0: # TODO: нет возможности получить этот поинт, сделать
        ...
        pi "— Я с вами. Ну что, ребята, как вам наша база?"
        "— Последняя надежда человечества, а столовая... Как у меня в школе."
        pi "— Ахах! Ну я бы не назвал это последней надеждой человечества. Таких баз много по миру. Возможно, в какой-то даже есть нормальная столовая. И девушек больше..."
