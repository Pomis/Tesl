...
label mission:
    ...
    "прохожий" "— Они хоть понимают, что их организм не приспособлен к этому? Убивают себя же."
    es "— Таким образом, только объединившись, мы сможем выжить."
...
# 
label nippur:
    "Давно я не перемещалась между городами. "
