...
label warBase:
    ...
    ma "— Не перебивай меня. Лава — в абсолютном большинстве случаев это базальтовые породы, наполовину состоящие из диоксида кремния."
    # bpaw: Абсолютое большинство. Мне это нравится
