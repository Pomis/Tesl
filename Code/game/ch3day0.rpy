...
label goHome:
    ...
    if yumingAlive:
        ...
        menu:
            "Подразнить":
                ...
                pi0 "— Что? Значит пока мы горбатились, выполняя задание, вы там в море развлекались?"
        ...
        # pomis: Задание? Он новобранец, не прошедший обучение же. Да и не сказано, в какой момент времени это произошло
        # bulka: тогда мб пилота слова будут? А про момент времени ясное дело, что в течение последней недели.
        # pomis: Да, пилоту по характеру больше подходит
        ...
        $ knowIvanName = True
        pi0 "— Ахах! Иваном. Ну я бы не назвал это последней надеждой человечества. Таких баз много по миру. Возможно, в какой-то даже есть нормальная столовая. И девушек больше..."
        "— Ну, тут девушек становится только меньше."
        "Слава сразу раскис. Так, надо поаккуратнее с фразами."
        pi0 "— Ты про боевые потери? Есть же новобранцы. Одной больше, другой меньше. А-ха-ха-ха!"
        sl "— Да о чём вы вообще! Мы здесь чтобы стать крутыми и защищать людей..."
        pi0 "— Тебя явно не это задело, да? Ты же постоянно бегал за этой китаянкой, что пропала на последней миссии? Как её там, не помню."
        sl "— Ни за кем я не бегал!"
        pi0 "— Да что ты как ребёнок-то? Ну ладно, как знаешь."
    ...
    # bulka: Это ресторан что ли, что им еду приносят? Сами по идее брать должны.
    # pomis: Нам в школе приносили, например. Хотя, в российской армии еду берут, ок.
