label ch5enlil_day2:
    ...
    if yenBalance>0:
        ...
        menu:
            "Попытаться украсть что-нибудь.":
                ...
                # bulka: откуда ей это знать, если она впервые в жизни утоляет голод?
    ...
    if iscraPoints > 1:
        ...
        isc0 "— Я так и не запомнила его имени... Он сейчас выйдет. Зачем он тебе вообще?"
    "— Нужен."
    ...
    menu:
        ...
        "Уйти":
            ...
            if iscraPoints > 3:
                ...
                isc0 "— Понятия не имею, зачем он тебе сдался... Впрочем, мне всё равно."
    ...
    "Боже, неужели это сработало?{w} Меня окружают идиоты..."
    # bulka: А может ввести чсв пойнты?
