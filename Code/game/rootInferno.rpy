...
label rootInferno:
    ...
    if roommatePoints>0:
        ...
        "Географически эти люди расположенны в разных уголках страны и в разное время. Есть упоминание и в моём городе. Можно попробовать пройти анализ в этом госпитале, только как мне объяснить врачу необходимость этого?"
            ...
            "Да не, ничего...":
                ...
                menu:
                    "Согласиться":
                        ...
                        "К нам выбежал охранник, испанцы бросились врассыпную. Да ладно..."
                        "Он что, правда думает, что я курил с ними анашу, или что там у них было?"
                        "Я уже не успевал никуда убежать, да и моя физическая форма не шла ни в какое сравнение с формой охранника."
                        "Охранник схватил меня за руку и повёл в сторону какой-то двери, попутно что-то говоря по-испански."
                        # Тут надо будет подробнее расписать. 
                        jump analysis
...
label fuckRoommate:
    ...
    menu:
        "Ударить кулаком":
            ...
            "Я ударяю ему в глаз, он сразу же отпускает мой палец, хватается за лицо, я наношу ещё один удар. {w}Следом, он одним ударом вырубает меня"
        "Пытаться освободить палец":
            "Свободной рукой я пытаюсь освободиться, но сосед гораздо сильнее меня. "
            menu:
                "Плюнуть соседу в лицо":
                    $ brokenFinger = True
                    "Я чувствую, как хрустят кости в пальце."
                "Закричать":
        "Закричать": 
