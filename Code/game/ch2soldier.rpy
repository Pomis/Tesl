...
label rootSoldier:
    ...
    "-----------> Тут они ждут вертолёт"
    "-----------> Тут их забирает генерал Ганц"

#(bulka: значит больше разговора нет? Если есть, то скорее всего маловажный и тут вступает наша новенькая
#(bulka: Тут может выяснится, что Юминг - подруга Марии, а Мария будет спрашивать гг о Юминг, если та умрет, к примеру. 