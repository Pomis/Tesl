...
label rootSoldier:
    ...
    "Она ввела код на замке кейса и он открылся, превратившись в небольшой военный ноутбук."
    "несколько секунд спустя послышался треск рации."
	...
	# Тут можно просто затухание экрана и переход
