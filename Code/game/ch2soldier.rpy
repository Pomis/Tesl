...
label rootSoldier:
    ...
    call flashback2
    play music kiitos
    scene bg ocean night onlayer background with flash
    ...
    nvlc "Мы расположились на обочине и ждали, когда прилетит последний вертолёт."
    nvlc "Тем временем, Юминг что-то доказывала стражам порядка на английском, а как ультимативный аргумент, достала корочку, чем изменила выражение их лиц со снисходительно-жалостливых на глубоко удивлённые."
