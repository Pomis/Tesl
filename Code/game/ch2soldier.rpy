...
label rootSoldier:
    ...
    "К нам подошли двое военных и жестом позвали за собой. Нас повезли отдельно от остальной группы на внедорожнике."
...
# pomis: не очень вписывается
    ...
    "— Конечно. Это же вертолет Ивана."

    "Достойное объяснение. Но, что вполне закономерно, я от этого еще сильнее испугался."

    "Только бы выжить! Только бы выжить! Какого черта это вообще со мной происходило?! Почему я? Почему никто другой?"

    "Я сам не заметил, как по-мертвецки уснул. Голоса плыли среди бесконечного океана звука, порождаемого бешеными лопастями."

    "И, когда я проснулся, мой вестибулярный аппарат дал полнейший сбой."

    "С трудом удерживая проклятие, готовое вырваться из моего желудка не самым традиционным способом, я встал."
