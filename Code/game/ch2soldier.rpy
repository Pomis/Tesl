...
label rootSoldier:
    ...
    "Ого, уже так темно...{w} Нас до сих пор не забрали вертолёты? {w}Хотя, нас до сих пор не убили..."
    ...
    # Так как они вышли на связь с помощью передатчика-приманки, а потом сигнал пропал, руководство пришло к выводу, что Инферно тут же их уничтожили на месте. Из-за этого спасательную операцию отменили.
    ...
    "— Это не Ка-60. {w}Это какой-то гражданский отстой."
    ...
    yu "— По правде говоря, эти испанцы даже не в курсе о существовании нашей базы, я просто сказала им набор кодовых слов, по которым русские должны понять ситуацию."
    ...
    "Ничего себе, бесцеремонность. Мы последовали за генералом и расположились внутри вертолёта. Снаружи выглядит как российский Ка-52. Но начинка очень необычна. Я никогда подобного не видел."
    "В кабине пилота даже нет привычных элементов управления."
    "Пилот заметил моё внимание, и повернулся ко мне."
    pi "— Приветствую на борту Чёрного Стрижа! Объясняю ситуацию."
