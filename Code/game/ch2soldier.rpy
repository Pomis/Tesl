...
label rootSoldier:
    ...
    "Военный."
    "— Черт, шевели булками! Гражданские, мля. Дали им спорт в массы. Занимайся! Не хочу спорт, хочу за компуктером сидеть! Мужики, называется..."
    # bpaw: хехе
...
#Stan: вот с этого места пиздец какой-то. голосую за откат на версию без наркоманов и перестрелок. И без истерики гг
    ...
    "— А он нас не угробит?"
    "Ясен пень, мне стало не по себе от такого «гостеприимства»."
    # К тому же едва ли наркоман, пусть даже торчок, способен адекватно управлять столь сложным видом транспорта."
