...
label rootSoldier:
    ...
    "Голова болела так, словно её зажали в тиски, а два красных чертёнка, сидящих на моих плечах, крутили рукоятку всякий раз, когда я пытался о чём-то подумать."
