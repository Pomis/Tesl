...
label rootSoldier:
    ...
    "Юминг обернулась, и, не заметив снаружи видимой угрозы, окончательно успокоилась."
    # bpaw: Как можно сдержанно улбнуться?
    # bulka: Ни обернуться, ни улбнуться сдержанно нельзя. А вот сдержанно улыбнуться можно...
    yu "— Погодка так себе."
    "— Согласен."
    "Я слишком устал, чтобы вести разговоры ни о чём. К тому же произошло слишком многое, чтобы я вообще мог трезво соображать."
