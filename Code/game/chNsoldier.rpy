label chNsoldier:
    ...
    sa "— Зачем же ты воюешь? Что тобой движет?"
...
label ending1:
        ...
        sa "— Да. Чем дольше ты под этим излучением, то больше вероятность пробуждения способности. А совместимость зависит уже от организма."
        ...
        "— ТВОЮ МАТЬ, ЧТО?"
        # sa "— А? Знаешь её? Ох, лол. Это твоя сестра. Ебать ты лох."
        # bulka: Не удержался.
        # pomis: xD
