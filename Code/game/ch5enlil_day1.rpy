...
label earth:
    ...
    port "— Проводили исследования по восстановлению нервной системы людей после контакта с нейронтами. Но пришлось свернуть деятельность в Токио из-за огромной ресурсоёмкости проекта и полного отсутствия прогресса."
    ...
    port "— Они обрекли миллионы своих жителей на гибель проведя массовые тесты на совместимость с нейронтами. Ты же знаешь, это губительно для них..."
    port "— Умрёт слишком много — мировой баланс нарушится. А за это уже придётся платить нам."
    "— Кошмарно..."
    port "— Ладно, проехали."
    if portPoints>0:
