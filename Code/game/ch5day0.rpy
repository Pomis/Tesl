label ch5day0:
    ...
    "Нам выдали оружие и кратко ввели в курс дела."
    nvl clear
    ...
    gen "— Как вы знаете, у большинства из вас уровень доступа А. Это позволит вам попасть на особо охраняемые территории в сопровождении людей с уровнем доступа А0. Такой есть у меня и Ивана. "
    # bulka: Немножко страненько, что такой доступ есть у нарика.
    # pomis: Ещё одна причина не делать его нариком
