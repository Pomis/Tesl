label ch4:
    ...
    if withMarieInHangar:
        ...
        gen "— Отменяю приказ уничтожения корабля. Мы связались с Пентагоном, корабль был угнан. Захватить. По возможности, не убивать военнослужащих США, они взяты в заложники."
        "Что? Он серьёзно?"
...
label reunion:
    ...
    if minoriAlive == False:
        ...
        if yumingAlive:
            ...
            "— Я нашёл её тело в капитанской кабине..."
    elif inferno==False:
