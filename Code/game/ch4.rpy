...
label reunion:
    ...
    gen "— Вы будете временно поселены в [townName]. Вы продолжите своё обучение. Правда, вместо Жорика вас будет инструктировать (пилот)" # pomis: нужно имя
    ...
    "Нас поселили в ближайшем городке — [cityName]. Классическая российская глубинка. "
    "Видимо, такая ситуация была предусмотрена, и нас разместили в нескольких служебных квартирах. Состояние так себе, конечно. И тесновато. {w}Сойдёт."
    "Моим соседом по комнате снова оказался Слава."
    # if antiTenkoPoints>0:
