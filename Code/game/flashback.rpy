...
label flashback6:
    ...
    "Теперь моя очередь надсмехаться над ним. Всё-таки тесты по географии были очень сложными и довольно редко, кто-то мог сдать их на отлично. У него же тоже далеко не всегда это получалось."
    return
